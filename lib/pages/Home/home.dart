...
class _HomePageState extends State<HomePage>
  ...
  void filterUsers() async {
    ...
    debugPrint("Length:${filteredUser!.length.toString()}");
    debugPrint("Length:${filteredUser.toString()}");
    debugPrint("Length:${user.toString()}");
  ...
  getUser() async {
    ...
    if (authToken == null) {
      prefs.clear();
      navigate(context: context, page: const LadingPage(), isDistroyed: true);
    }
    upDateApp();
    debugPrint("Data:$id");
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: (filteredUser!.isEmpty)
                          ? "No Account Around You Right Now "
                              .text
                              .make()
                              .centered()
                          : TinderSwapCard(
                              ...
                              swipeCompleteCallback:
                                ...
                                if ((filteredUser![index].id != id)) {
                                  if (orientation.name == "right") {
                                    final url = Uri.parse(
                                        "https://api-relation.vercel.app/like");
